...
public:
    ...
    void setupUi(QDialog *modifiermachine)
    {
        ...
        modifiermachine->resize(580, 410);
        modifiermachine->setStyleSheet(QString::fromUtf8("background-color: rgb(157, 188, 187);\n"
"border-color: rgb(239, 245, 241);"));
        confirmerButton = new QPushButton(modifiermachine);
        confirmerButton->setObjectName("confirmerButton");
        confirmerButton->setGeometry(QRect(210, 330, 161, 41));
...
""));
        ...
        annulerButton->setGeometry(QRect(380, 330, 161, 41));
...
""));
        ...
        lineEdit_3->setGeometry(QRect(10, 60, 581, 61));
...
"color:red; }"));
        ...
        lineEdit_4->setGeometry(QRect(130, 120, 361, 61));
...
"color:black; }"));
        ...
        lineEdit_5->setGeometry(QRect(120, 160, 361, 61));
...
"color:black; }"));
        ...
        lineEdit_6->setGeometry(QRect(50, 200, 361, 61));
...
"color:black; }"));
        ...
        lineEdit_7->setGeometry(QRect(80, 240, 361, 61));
...
"color:black; }"));
        ...
        lineEdit_8->setGeometry(QRect(100, 10, 391, 61));
...
"color:black; }"));
        ...
        date_maintenance->setGeometry(QRect(310, 220, 191, 29));
...
""));
        ...
        id_machine->setGeometry(QRect(380, 80, 171, 21));
...
"}"));
        ...
        type_m->setGeometry(QRect(310, 140, 191, 31));
