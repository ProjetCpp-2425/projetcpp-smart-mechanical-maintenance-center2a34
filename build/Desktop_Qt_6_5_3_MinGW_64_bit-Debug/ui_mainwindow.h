...
""));
        ...
        Id->setObjectName("Id");
        Id->setGeometry(QRect(990, 290, 191, 31));
        Id->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
        Mdp = new QLineEdit(page_2);
        Mdp->setObjectName("Mdp");
        Mdp->setGeometry(QRect(990, 380, 191, 31));
        Mdp->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
...
"background-color: rgb(255, 255, 255);"));
        special_e = new QLineEdit(employes);
        special_e->setObjectName("special_e");
        special_e->setGeometry(QRect(380, 500, 181, 21));
        special_e->setStyleSheet(QString::fromUtf8("\n"
"background-color: rgb(255, 255, 255);"));
...
"}\n"
""));
        Email_Ajout = new QLineEdit(page_3);
        Email_Ajout->setObjectName("Email_Ajout");
        Email_Ajout->setGeometry(QRect(990, 230, 191, 31));
        Email_Ajout->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
        Id_Ajout = new QLineEdit(page_3);
        Id_Ajout->setObjectName("Id_Ajout");
        Id_Ajout->setGeometry(QRect(1000, 300, 191, 31));
        Id_Ajout->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
        Nom_Ajout = new QLineEdit(page_3);
        Nom_Ajout->setObjectName("Nom_Ajout");
        Nom_Ajout->setGeometry(QRect(990, 370, 191, 31));
        Nom_Ajout->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
        Prenom_Ajout = new QLineEdit(page_3);
        Prenom_Ajout->setObjectName("Prenom_Ajout");
        Prenom_Ajout->setGeometry(QRect(990, 430, 191, 31));
        Prenom_Ajout->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
        Num_Ajout = new QLineEdit(page_3);
        Num_Ajout->setObjectName("Num_Ajout");
        Num_Ajout->setGeometry(QRect(990, 490, 191, 31));
        Num_Ajout->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
        Mdp_Ajout = new QLineEdit(page_3);
        Mdp_Ajout->setObjectName("Mdp_Ajout");
        Mdp_Ajout->setGeometry(QRect(990, 560, 191, 31));
        Mdp_Ajout->setStyleSheet(QString::fromUtf8("background-color: transparent;\n"
"border: none;\n"
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        etat_e->setItemText(0, QCoreApplication::translate("MainWindow", "Etat", nullptr));
        etat_e->setItemText(1, QCoreApplication::translate("MainWindow", "Disponible", nullptr));
        etat_e->setItemText(2, QCoreApplication::translate("MainWindow", "Occup\303\251", nullptr));
